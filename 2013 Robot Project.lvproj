...
<Project Type="Project" LVVersion="12008004">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Arm Loop.vi" Type="VI" URL="../Arm Loop.vi"/>
		<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
		<Item Name="Get Digital Input.vi" Type="VI" URL="../Get Digital Input.vi"/>
		<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
		<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
		<Item Name="Sync Move Arm to.vi" Type="VI" URL="../Sync Move Arm to.vi"/>
		<Item Name="Auton Globals.vi" Type="VI" URL="../Auton Globals.vi"/>
		<Item Name="Arm Globals.vi" Type="VI" URL="../Arm Globals.vi"/>
		<Item Name="Sidestep Globals.vi" Type="VI" URL="../Sidestep Globals.vi"/>
		<Item Name="Config Load Arm Globals.vi" Type="VI" URL="../Config Load Arm Globals.vi"/>
		<Item Name="Config Load Auton Globals.vi" Type="VI" URL="../Config Load Auton Globals.vi"/>
		<Item Name="Config Load Sidestep Globals.vi" Type="VI" URL="../Config Load Sidestep Globals.vi"/>
		<Item Name="Config Load Robot Globals.vi" Type="VI" URL="../Config Load Robot Globals.vi"/>
		<Item Name="Config Write Sidestep Globals.vi" Type="VI" URL="../Config Write Sidestep Globals.vi"/>
		<Item Name="Config Write Auton Globals.vi" Type="VI" URL="../Config Write Auton Globals.vi"/>
		<Item Name="Config Write Arm Globals.vi" Type="VI" URL="../Config Write Arm Globals.vi"/>
		<Item Name="Config Write Robot Globals.vi" Type="VI" URL="../Config Write Robot Globals.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Set Drive Output.vi" Type="VI" URL="../Set Drive Output.vi"/>
			<Item Name="Threshold Gate.vi" Type="VI" URL="../Threshold Gate.vi"/>
			<Item Name="Get Joystick Axis.vi" Type="VI" URL="../Get Joystick Axis.vi"/>
			<Item Name="Publish Joystick Data.vi" Type="VI" URL="../Publish Joystick Data.vi"/>
			<Item Name="Set Motor Output.vi" Type="VI" URL="../Set Motor Output.vi"/>
			<Item Name="Get Joystick Button.vi" Type="VI" URL="../Get Joystick Button.vi"/>
			<Item Name="Encoder Get.vi" Type="VI" URL="../Encoder Get.vi"/>
			<Item Name="provcom_GenerateGUID.vi" Type="VI" URL="/&lt;resource&gt;/Framework/Providers/Common/provcom_GenerateGUID.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="Init Drive.vi" Type="VI" URL="../Init Drive.vi"/>
			<Item Name="Init Motor.vi" Type="VI" URL="../Init Motor.vi"/>
			<Item Name="Init Encoder.vi" Type="VI" URL="../Init Encoder.vi"/>
			<Item Name="Setup Camera.vi" Type="VI" URL="../Setup Camera.vi"/>
			<Item Name="Init Joystick.vi" Type="VI" URL="../Init Joystick.vi"/>
			<Item Name="Init Digital Input.vi" Type="VI" URL="../Init Digital Input.vi"/>
...
KeepAliveTimeout 60
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Publish Data" Type="Folder">
				<Item Name="Publish Joystick Data.vi" Type="VI" URL="../Publish Joystick Data.vi"/>
			</Item>
			...
			<Item Name="Multiplier 1.vi" Type="VI" URL="../Multiplier 1.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
